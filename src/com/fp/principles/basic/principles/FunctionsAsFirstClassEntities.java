...
public class FunctionsAsFirstClassEntities {

    public static void main(String[] args) {
        //assignment to variable
        Function<Integer, Integer> f = FunctionsAsFirstClassEntities::square;
        print(f);
        ...
        Integer result3 = Optional.of(2).map(FunctionsAsFirstClassEntities::square).get(); //result3 = 4
        print(result3);
        ...
        List<Function<Integer, Integer>> functions = List.of(FunctionsAsFirstClassEntities::square, getSquareFunction());
        print(functions);
    }

    //get the function as a result of other function call
    static Function<Integer, Integer> getSquareFunction() {
        return FunctionsAsFirstClassEntities::square;
    }
